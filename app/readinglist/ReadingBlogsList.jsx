...
const ReadingBlogsList = () => {
    return (
        <div className='w-full h-screen md:mt-6'>

            {/* heading */}
            <h2 className='text-2xl font-semibold px-3 mb-3'>Reading List</h2>
...
export default ReadingBlogsList